...
import  "https://github.com/0xjac/ERC1820/blob/master/contracts/ERC1820Client.sol";
import  "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/math/SafeMath.sol";
import  "https://github.com/0xjac/ERC777/blob/devel/contracts/ERC777Token.sol";
import  "https://github.com/0xjac/ERC777/blob/devel/contracts/ERC777TokensSender.sol";
import  "https://github.com/0xjac/ERC777/blob/devel/contracts/ERC777TokensRecipient.sol";
...
contract ERC777BaseToken is ERC777Token, ERC1820Client {
    ...
    event Burned(address indexed operator, address indexed _from, uint256 amount, bytes data, bytes operatorData);
    ...
    function isOperatorFor(address _operator, address _tokenHolder) public view returns (bool) {
      	if(_operator == _tokenHolder){
      		return true;
      	}
      	if(mAuthorizedOperators[_operator][_tokenHolder]){
      		return true;
      	}
      	if(!mRevokedDefaultOperator[_operator][_tokenHolder] && mIsDefaultOperator[_operator]){
      		return true;
      	} 
    }
        ...
        internal
    {
        ...
        if (recipientImplementation != address(0)) {
            ERC777TokensRecipient(recipientImplementation).tokensReceived(
        	 ...
        	 if (_preventLocking) {
        	 	if(isRegularAddress(_to)){
        	 		revert("Cannot send to contract without ERC777TokensRecipient");
        	 	}
             }
        }
    }
